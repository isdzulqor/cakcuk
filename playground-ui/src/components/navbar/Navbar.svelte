...
<div>
    <div class="home-menu pure-menu-horizontal pure-menu-fixed {state}">
        ...
        <ul class="pure-menu-list">
            ...
            <li class="pure-menu-item">
                <!-- <Navigate class="link-menu" to="play"> -->
                <a href="#/play" class="pure-menu-link">Play</a>
                <!-- </Navigate> -->
            </li>
            <li class="pure-menu-item">
                <!-- <Navigate class="link-menu" to="faq"> -->
                <a href="#/faq" class="pure-menu-link">FAQ</a>
                <!-- </Navigate> -->
            </li>
            <li class="pure-menu-item pure-menu-selected link-special">
                <!-- <Navigate class="link-menu" to="docs"> -->
